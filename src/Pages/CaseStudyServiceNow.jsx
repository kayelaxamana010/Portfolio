...
/**
 * Case Study Detail Page: ServiceNow Automation for Database User Access
 * Matches the main portfolio theme (light/dark mode aware)
 */

export default function CaseStudyServiceNow() {
    ...
    <div className="min-h-screen w-full bg-light-bg dark:bg-dark-bg transition-colors duration-300">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 pt-24">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm text-light-text-secondary dark:text-dark-text-secondary" data-aos="fade-down">
          ...
          <span className="opacity-60">›</span>
          <span className="font-medium text-light-text dark:text-dark-text">ServiceNow Automation</span>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-1">
          ...
          <div data-aos="fade-right">
            ...
            <p className="mt-5 max-w-2xl text-light-text-secondary dark:text-dark-text-secondary leading-relaxed">
              Automated intake and fulfillment of MySQL/Aurora DB user access via ServiceNow. Applied least-privilege by environment, stored credentials in the vault, and notified users with time-boxed links.
            </p>

            {/* Stats tiles */}
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { label: "Coverage", value: "US & APAC servers" },
                { label: "Access Model", value: "Prod: Read | Non-prod: Read/Write" },
                { label: "Notifications", value: "Email + 12-24h links" },
              ].map((m, idx) => (
                <div
                  key={m.label}
                  data-aos="fade-up"
        ...
        <div className="mt-8 rounded-3xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 p-6 shadow-soft dark:shadow-none backdrop-blur-lg" data-aos="fade-up">
              ...
              <ul className="space-y-3 text-light-text-secondary dark:text-dark-text-secondary">
                <li className="flex items-start gap-3">
                  ...
                  <span>Single ServiceNow form captures request and routes to the DevOps queue.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-light-accent dark:bg-dark-accent flex-shrink-0"></span>
                  <span>Create user accounts on target DBs and grant permissions by environment (Production: READ only; Non-production: READ + WRITE).</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-light-accent dark:bg-dark-accent flex-shrink-0"></span>
                  <span>Store/rotate credentials in the password vault; provide reset/new links with expiry (reset: 12h; new: 24h).</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-light-accent dark:bg-dark-accent flex-shrink-0"></span>
                  <span>Email the requestor with completion details; amendments supported via the same form when DB is not listed.</span>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3" data-aos="fade-up">
          ...
          <div className="rounded-3xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 p-6 shadow-soft dark:shadow-none backdrop-blur-lg">
            ...
            <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary leading-relaxed">
              High volume of database access requests to EDP MySQL servers were processed manually—user creation, permissions, storing passwords in the vault, and emailing users.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 p-6 shadow-soft dark:shadow-none backdrop-blur-lg">
            ...
            <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary leading-relaxed">
              Automate end-to-end handling in ServiceNow with environment-aware permissions, password management, and clear notifications.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 p-6 shadow-soft dark:shadow-none backdrop-blur-lg">
            ...
            <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary leading-relaxed">
              Built ServiceNow form routing to DevOps queue, automated DB user provisioning with environment-based permissions, and integrated password vault with time-boxed notification links.
            </p>
          </div>
        </div>
        ...
        {/* Outcome Section */}
        <div className="mt-8 rounded-3xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 p-6 shadow-soft dark:shadow-none backdrop-blur-lg" data-aos="fade-up">
          <h3 className="text-xl font-semibold text-light-text dark:text-dark-text mb-4">Outcome</h3>
          <p className="text-light-text-secondary dark:text-dark-text-secondary leading-relaxed mb-4">
            Consistent, auditable provisioning across regions (US, APAC) with standard service accounts; manual edge cases handled via the same workflow.
          </p>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl bg-light-bg-secondary dark:bg-black/20 p-4 border border-gray-200 dark:border-white/5">
              ...
              <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
                Reduced manual processing time by 80%, improved security with automated credential rotation, and enhanced user experience with instant notifications.
              </p>
            </div>
            <div className="rounded-2xl bg-light-bg-secondary dark:bg-black/20 p-4 border border-gray-200 dark:border-white/5">
              <h4 className="font-semibold text-light-text dark:text-dark-text mb-2 text-sm">Benefits</h4>
              <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
                Standardized access provisioning, automated compliance tracking, seamless integration with existing workflows, and scalable across multiple regions.
              </p>
            </div>
          </div>
        </div>
